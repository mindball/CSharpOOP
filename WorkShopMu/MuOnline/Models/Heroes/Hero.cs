namespace MuOnline.Models.Heroes
{
    ...
    public abstract class Hero : IHero, IIdentifiable, IProgress
    {
        ...
        public int Strength
        {
            ...
            private set
            {
                HeroValidator.ValidHero(nameof(this.Strength), value);
        ...
        public int Agility
        {
            ...
            private set
            {
                HeroValidator.ValidHero(nameof(this.Agility), value);
        ...
        public int Stamina
        {
            ...
            private set
            {
                HeroValidator.ValidHero(nameof(this.Stamina), value);
        ...
        public int Energy
        {
            ...
            private set
            {
                HeroValidator.ValidHero(nameof(this.Energy), value);
        ...
        public int Experience
        {
            ...
            private set
            {
                HeroValidator.ValidHero(nameof(this.Experience), value);
        ...
        public int Level
        {
            ...
            private set
            {
                HeroValidator.ValidHero(nameof(this.Level), value);
        ...
        public int Resets
        {
            ...
            private set
            {
                HeroValidator.ValidHero(nameof(this.Resets), value);
        ...
        //TODO implemete AddReset()
        private void AddReset()
        {
            throw new NotImplementedException();
        }
        //TODO implemete AddLevel()
        ...
        public int TotalAgilityPoints
        {
            ...
            private set
            {
                if (value < 0)
                {
                    throw new ArgumentException("TotalAgilityPoints cannot be less than zero!");
                }
        ...
        public int TotalStaminaPoints
        {
            ...
            private set
            {
                if (value < 0)
                {
                    throw new ArgumentException("TotalStaminaPoints cannot be less than zero!");
                }
