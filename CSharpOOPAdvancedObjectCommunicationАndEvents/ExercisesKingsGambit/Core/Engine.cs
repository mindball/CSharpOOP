using ExercisesKingsGambit.Contracts;
using ExercisesKingsGambit.Models;
using System;
using System.Collections.Generic;
using System.Linq;

namespace ExercisesKingsGambit.Core
{
    class Engine
    {
        ...
        public void Run()
        {
            ...
            while (!input.Equals("End"))
            {
                ...
                {
                    this.newKing.Subordinates.First(x => x.Name == tokens[1]).Kill();
                }
