...
namespace ConsoleApplication1
{
    class Program
    {
        ...
        //multicast delegate
        public static void PrintNumber3(int num)
        {
        ...
        private void createLists()
        {
            ...
            productList =
                new List<Product> {
                    ...
                    new Product { ProductID = 22, ProductName = "Gustaf's Knackebrod", Category = "Grains/Cereals", UnitPrice = 21.0000M, UnitsInStock = 104 },
                    new Product { ProductID = 23, ProductName = "Tunnbrod", Category = "Grains/Cereals", UnitPrice = 9.0000M, UnitsInStock = 61 },
                    new Product { ProductID = 24, ProductName = "Guarana Fantastica", Category = "Beverages", UnitPrice = 4.5000M, UnitsInStock = 20 },
                    new Product { ProductID = 25, ProductName = "NuNuCa Nu?-Nougat-Creme", Category = "Confections", UnitPrice = 14.0000M, UnitsInStock = 76 },
                    new Product { ProductID = 26, ProductName = "Gumbar Gummibarchen", Category = "Confections", UnitPrice = 31.2300M, UnitsInStock = 15 },
                    new Product { ProductID = 27, ProductName = "Schoggi Schokolade", Category = "Confections", UnitPrice = 43.9000M, UnitsInStock = 49 },
                    new Product { ProductID = 28, ProductName = "Rossle Sauerkraut", Category = "Produce", UnitPrice = 45.6000M, UnitsInStock = 26 },
                    new Product { ProductID = 29, ProductName = "Thuringer Rostbratwurst", Category = "Meat/Poultry", UnitPrice = 123.7900M, UnitsInStock = 0 },
                    ...
                    new Product { ProductID = 38, ProductName = "Cote de Blaye", Category = "Beverages", UnitPrice = 263.5000M, UnitsInStock = 17 },
                    ...
                    new Product { ProductID = 54, ProductName = "Tourtiere", Category = "Meat/Poultry", UnitPrice = 7.4500M, UnitsInStock = 21 },
                    new Product { ProductID = 55, ProductName = "Pate chinois", Category = "Meat/Poultry", UnitPrice = 24.0000M, UnitsInStock = 115 },
                    ...
                    new Product { ProductID = 61, ProductName = "Sirop d'erable", Category = "Condiments", UnitPrice = 28.5000M, UnitsInStock = 113 },
                    ...
                    new Product { ProductID = 64, ProductName = "Wimmers gute Semmelknodel", Category = "Grains/Cereals", UnitPrice = 33.2500M, UnitsInStock = 22 },
                    ...
                    new Product { ProductID = 73, ProductName = "Rod Kaviar", Category = "Seafood", UnitPrice = 15.0000M, UnitsInStock = 101 },
                    new Product { ProductID = 74, ProductName = "Longlife Tofu", Category = "Produce", UnitPrice = 10.0000M, UnitsInStock = 4 },
                    new Product { ProductID = 75, ProductName = "Rhonbrau Klosterbier", Category = "Beverages", UnitPrice = 7.7500M, UnitsInStock = 125 },
                    new Product { ProductID = 76, ProductName = "Lakkalikoori", Category = "Beverages", UnitPrice = 18.0000M, UnitsInStock = 57 },
                    new Product { ProductID = 77, ProductName = "Original Frankfurter grune So?e", Category = "Condiments", UnitPrice = 13.0000M, UnitsInStock = 32 }
            };
        }
